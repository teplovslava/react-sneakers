 ...
 const Header =(props)=>{
    return(
        ...
        <div className={style.headerLeft}>        
            <img width={40} height={40} className={style.logo} src={logo} alt='logo'/>
            <div className={style.headerMain}>
              <h3 className={style.headerH3}>React Sneakers</h3>
              <p className={style.HeaderDescr}>Магазин кроссовок</p>
            </div>
        </div>
        <ul className={style.headerRight}>
          <li onClick={props.onClickCart} className={style.headerItem}>
          <svg className={style.headerImg}  width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
